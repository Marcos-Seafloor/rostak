...
class CotUtility:
    ...
    def new_status_msg(self, stale_in = 60, heading = 0.0, speed = 0.0) -> str:
        return ET.tostring(
            self.new_status(stale_in, heading, speed)
        ).decode()
    ...
    def new_status(self, stale_in = 60, heading = 0.0, speed = 0.0) -> ET.Element:
